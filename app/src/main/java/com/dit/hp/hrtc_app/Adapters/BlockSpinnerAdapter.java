...
public class BlockSpinnerAdapter extends ArrayAdapter<BlockPojo> {

    private Context context;
    private List<BlockPojo> values;

    public BlockSpinnerAdapter(Context context, int textViewResourceId, List<BlockPojo> values) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        label.setText(values.get(position).getBlockName());
