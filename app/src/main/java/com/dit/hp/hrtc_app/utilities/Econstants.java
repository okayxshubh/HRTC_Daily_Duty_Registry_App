...
public class Econstants {
    ...
    public static final String getOTPMethod = "/ldap/getOtpByMobile";
    public static final String verifyOTPMethod = "/ldap/verifyOTP";
...
//    public static final String base_url = "https://himstaging1.hp.gov.in/hrtc"; // Staging
    ...
    // Used For: Office Creation + Getting Token HimAccess + Getting User Details
//    public static final String sarvatra_url = "https://himstaging1.hp.gov.in/sarvatra-api"; public static final Integer REGIONAL_OFFICE_ID = 369;  //Staging HIM ACCESS + Staging Regional Office ID
    ...
    // ATTENDANCE
    public static final String methodSaveAttendance = "/attendance/save";      // For Live add:  /hrtc else remove
    ...
    // Global Method For Applying Theme.. Avoid Theme Switching on crash
    public static void loadPrefsNApplyTheme(Context context) {
