...
public class ProfileScreen extends BaseDrawerActivity implements ShubhAsyncTaskListenerGet {
    ...
    List<AdditonalChargePojo> additionalChargeList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        username.setText(Preferences.getInstance().userName != null ? Preferences.getInstance().userName : "Usernmae Not Available");

        deptName.setText(Preferences.getInstance().officeTypeName != null ? "Office Type: " + Preferences.getInstance().officeTypeName : "Department Not Available");
        designation.setText(Preferences.getInstance().designationName != null ? "Designation: " + Preferences.getInstance().designationName : "Designation Not Available");

        role.setText(Preferences.getInstance().roleName != null ? "Role: " + Preferences.getInstance().roleName : "Role: Normal User");

        email.setText(Preferences.getInstance().emailID != null ? Preferences.getInstance().emailID : "Email Not Available");

        employeeId.setText(Preferences.getInstance().empId != null ? String.valueOf(Preferences.getInstance().empId) : "Emp ID Not Available");
        phone.setText(Preferences.getInstance().mobileNumber != null ? Preferences.getInstance().mobileNumber : "Ph. No. Not Available");
        dob.setText(Preferences.getInstance().dateOfBirth != null ? Preferences.getInstance().dateOfBirth : "DOB Not Available");
            ...
            if (responseObject != null) {
                ...
                if (responseObject.getResponseCode().equalsIgnoreCase(Integer.toString(HttpsURLConnection.HTTP_OK))) {
                    ...
                    if (response.getStatus().equalsIgnoreCase("OK")) {
                        ...
                        // All Charges List
                        additionalChargeList = new ArrayList<>();
