...
//                this.finish(); // Finish Previous Activity
    ...
    private void reloadUserDetails() {
        ...
        String user_mail = pref.emailID != null && !pref.emailID.isEmpty() ? pref.emailID : "No User ID Available";
        String role = pref.roleName != null && !pref.roleName.isEmpty() ? pref.roleName : "No Role Available";
        String mobileNumber = pref.mobileNumber != null && !pref.mobileNumber.isEmpty() ? pref.mobileNumber : "Ph. No. Available";


//        String depot = pref.regionalOfficeName != null && !pref.regionalOfficeName.isEmpty() ? pref.regionalOfficeName : "No Regional Office Available";

        headerNameTV.setText(name);
        headerRoleTV.setText(mobileNumber);
        headerOfficeTV.setText(user_mail);
    }
    ...
    private void showLogoutConfirmationDialog() {
        new android.app.AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", (dialog, id) -> {
                    ...
                    Intent intent = new Intent(BaseDrawerActivity.this, MobileLoginHRTC.class);
