...
public class PanchayatSpinnerAdapter extends ArrayAdapter<PanchayatPojo> {

    private Context context;
    private List<PanchayatPojo> values;

    public PanchayatSpinnerAdapter(Context context, int textViewResourceId, List<PanchayatPojo> values) {
    ...
    public PanchayatPojo getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        label.setText(values.get(position).getPanchayatName());
