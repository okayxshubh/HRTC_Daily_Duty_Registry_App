...
public class VillageSpinnerAdapter extends ArrayAdapter<VillagePojo> {

    private Context context;
    private List<VillagePojo> values;

    public VillageSpinnerAdapter(Context context, int textViewResourceId, List<VillagePojo> values) {
    ...
    public VillagePojo getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        label.setText(values.get(position).getVillage());
