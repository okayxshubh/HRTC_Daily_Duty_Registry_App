...
public class MunicipalSpinnerAdapter extends ArrayAdapter<MunicipalPojo> {

    private Context context;
    private List<MunicipalPojo> values;

    public MunicipalSpinnerAdapter(Context context, int textViewResourceId, List<MunicipalPojo> values) {
    ...
    public MunicipalPojo getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        label.setText(values.get(position).getMunicipalName());
