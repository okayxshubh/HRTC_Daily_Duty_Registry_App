...
public class CaptureResponse extends PidData {
    ...
    public static CaptureResponse fromCaptureRdResponse(CaptureRdResponse rdResponse, String txnStatus) {
        ...
        NameValue imageScoreSheet = new NameValue("imageScoreSheet", rdResponse.getTxnId());
        captureResponse.custOpts.nameValues.add(imageScoreSheet);

        NameValue faceRdVersionWithEnv = new NameValue("faceRdVersionWithEnv", rdResponse.getTxnId());
        captureResponse.custOpts.nameValues.add(faceRdVersionWithEnv);
    ...
    public String getImageScoreSheet() {
        ...
        for (NameValue nv : custOpts.nameValues) {
            if (nv.getName().equals("imageScoreSheet")) {
                return nv.getValue();
            }
        }
        return "";
    ...
    public String getFaceRdVersionWithEnv() {
        ...
        for (NameValue nv : custOpts.nameValues) {
            if (nv.getName().equals("faceRdVersionWithEnv")) {
                return nv.getValue();
            }
        }
        return "";
