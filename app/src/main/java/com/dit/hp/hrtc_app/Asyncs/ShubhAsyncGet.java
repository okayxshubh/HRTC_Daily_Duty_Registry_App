...
//                Data_From_Server = http_manager.GetDataWithoutJWT(uploadObjects[0]);
            ...
            else if (uploadObjects[0].getTasktype().toString().equalsIgnoreCase(TaskType.DOWNLOAD_SALARY_SLIP.toString())) {
                Log.e("We Here", uploadObjects[0].getMethordName());
                Data_From_Server = http_manager.GetData(uploadObjects[0]);
                Log.e("ShubhAsyncGet", "Data from Server: " + uploadObjects[0].getMethordName());
                return Data_From_Server;
            ...
            // VERIFY HRTC LOGIN OTP
            else if (uploadObjects[0].getTasktype().toString().equalsIgnoreCase(TaskType.VERIFY_OTP_LOGIN.toString())) {
                Log.e("We Here", uploadObjects[0].getMethordName());
                Data_From_Server = http_manager.GetDataWithoutJWT(uploadObjects[0]);
                Log.e("ShubhAsyncGet", "Data from Server: " + uploadObjects[0].getMethordName());
                return Data_From_Server;
            ...
            // CHECK
            else if (uploadObjects[0].getTasktype().toString().equalsIgnoreCase(TaskType.CHECK_EMPLOYEE_CODE.toString())) {
                Log.e("We Here", uploadObjects[0].getMethordName());
                Data_From_Server = http_manager.GetData(uploadObjects[0]);
                Log.e("ShubhAsyncGet", "Data from Server: " + uploadObjects[0].getMethordName());
                return Data_From_Server;
