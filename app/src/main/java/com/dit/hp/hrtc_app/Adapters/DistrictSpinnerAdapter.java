...
public class DistrictSpinnerAdapter extends ArrayAdapter<DistrictPojo> {

    private Context context;
    private List<DistrictPojo> values;

    public DistrictSpinnerAdapter(Context context, int textViewResourceId, List<DistrictPojo> values) {
        super(context, textViewResourceId, values);
        this.context = context;
        this.values = values;
    }

    public DistrictSpinnerAdapter(@NonNull Context context, int resource, int textViewResourceId) {
