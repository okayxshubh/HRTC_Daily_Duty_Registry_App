...
public class OfficeSpinnerAdapter extends ArrayAdapter<OfficePojo> {

    private Context context;
    private List<OfficePojo> values;

    public OfficeSpinnerAdapter(Context context, int textViewResourceId, List<OfficePojo> values) {
        super(context, textViewResourceId, values);
        this.context = context;
        this.values = values;
    }

    public OfficeSpinnerAdapter(@NonNull Context context, int resource, int textViewResourceId) {
    ...
    public OfficePojo getItem(int position) {
